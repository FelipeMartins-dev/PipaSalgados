...
<nav class="navbar navbar-expand-lg navbar-glass border-bottom sticky-top shadow-sm">
    ...
    <a class="nav-link position-relative" href="/PipaSalgados/carrinho.php">
        
        <!-- Ícone -->
        <svg id="cart-icon" xmlns="http://www.w3.org/2000/svg" width="32" height="32"
            ...
            M3.14 5l.5 2H5V5zM6 5v2h2V5zm3 0v2h2V5zm3 0v2h1.36l.5-2zm1.11 3H12v2h.61zM11 8H9v2h2zM8 8H6v2h2zM5 8H3.89l.5 2H5zm0 5a1 1 0 1 0 0 2
            1 1 0 0 0 0-2m-2 1a2 2 0 1 1 4 0 2 2 0 0 1-4 0m9-1a1 1 0 1 0 0 2
            1 1 0 0 0 0-2m-2 1a2 2 0 1 1 4 0 2 2 0 0 1-4 0"/>
        </svg>
